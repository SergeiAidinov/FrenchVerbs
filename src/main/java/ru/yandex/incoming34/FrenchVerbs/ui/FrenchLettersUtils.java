...
public class FrenchLettersUtils {
	...
	public enum Letters {
		...
		A_ACCENT_GRAVE(_A_ACCENT_GRAVE), E_ACCENT_GRAVE(_E_ACCENT_GRAVE), U_ACCENT_GRAVE(_U_ACCENT_GRAVE),
		A_ACCENT_CIRCONFLEXE(_A_ACCENT_CIRCONFLEXE), E_ACCENT_CIRCONFLEXE(_E_ACCENT_CIRCONFLEXE),
		I_ACCENT_CIRCONFLEXE(_I_ACCENT_CIRCONFLEXE), O_ACCENT_CIRCONFLEXE(_O_ACCENT_CIRCONFLEXE),
		U_ACCENT_CIRCONFLEXE(_U_ACCENT_CIRCONFLEXE), CEDILLE(_CEDILLE), E_TREMA(_E_TREMA), I_TREMA(_I_TREMA),
		U_TREMA(_U_TREMA), Y_TREMA(_Y_TREMA), AE_LIGATURA(_AE_LIGATURA), OE_LIGATURA(_OE_LIGATURA);
